...
## Telas (§4.1)
`/login` · `/` Painel (fiel ao protótipo §4.2) · `/frota` · `/veiculacoes` · `/disponibilidade` · `/anunciantes` · `/os` (mobile-first, foto) · `/importacao` · `/relatorios` · `/configuracoes` (aparência + planos)
