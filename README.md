...
## Telas (§4.1)
`/login` · `/` Painel (fiel ao protótipo §4.2) · `/editar` (edição inline por veículo) · `/frota` · `/os` (mobile-first, foto) · `/importacao` · `/relatorios` · `/configuracoes` (aparência) · `/usuarios` (perfis + abas por usuário)
